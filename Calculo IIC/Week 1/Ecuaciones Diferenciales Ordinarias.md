...
Es la representación más general, donde todas las variables se igualan a cero:
...
- **$y$**: es la variable dependiente (función de $x$).
    
- **$y', y'', \dots, y^{(n)}$**: son las derivadas de $y$ respecto a $x$.
    
- **$F$**: es una función que relaciona estas variables.

---
>Una ecuación, para ser una diferencial ordinaria, debe tener al menos una derivada. Si no hay una derivada, tengo una simple ecuación algebraica que no describe como cambia una variable respecto a otra. 
