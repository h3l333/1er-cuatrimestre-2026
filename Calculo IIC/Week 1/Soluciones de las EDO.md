### Solución general
>Familia de funciones ([[Familia de funciones]]) que conjuntamente con sus derivadas son reemplazadas en la EDO y la transforman en una identidad ([[Identidades]]).

La familia de funciones que conforman la solución general satisfacen la EDO original de tal modo que al sustituir la derivada de la EDO original con la solución general la igualdad se cumple.

---
### Solución Particular 
>Constituye un ejemplar de la misma familia de funciones a la que hace referencia la solución general.
